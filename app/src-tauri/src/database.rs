...
impl AppPersonalization {
    pub fn new(theme: Option<String>, language: Option<String>, first_name: Option<String>, last_name: Option<String>, email: Option<String>, preferred_voice: Option<String>) -> Self {
        Self { theme, language, first_name, last_name, email, preferred_voice }
    }
}
