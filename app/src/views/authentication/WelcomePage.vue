<template>
  ...
  >
    ...
    />
    <h1 class="text-7xl leading-20 text-center"
      >Book streaming platform!</
    h1>
    <p class="leading-loose text-gray-400 text-center mt-4">
      Convert text documents to audio books, share, collaborate and learn
    </p>
    ...
    >
      <AppButton
        class="border-app-orange col-span-1 text-app-orange rounded-2xl border"
        >Login
      </AppButton>

      <AppButton
        class="border-app-orange col-span-1 text-app-dark bg-app-orange rounded-2xl border"
        >Sign up
      </AppButton>
    </div>
    <a href="#" class="leading-loose text-gray-400/50  mx-auto text-center mt-4 relative -bottom-20">
