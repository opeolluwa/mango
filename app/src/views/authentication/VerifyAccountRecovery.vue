      ...
      <div class="flex flex-col w-full">
        ...
        >
          <PinInputInput
            ...
            :key="id"
            :index="index"
            class="size-12 border-stone-600 dark:border-stone-500 hover:border-app-orange rounded-lg text-center shadow-sm border text-green10 placeholder:text-mauve8 focus:shadow-[0_0_0_2px] focus:shadow-app-orange outline-none"
          />
        </PinInputRoot>
      </div>
